...
namespace math {
	...
	void vectornagles_2d(const Vector& forward, QAngle& angles, Vector* up = nullptr);
	...
	void AngleVectorsNothing(const QAngle& vecAngles, Vector& vecForward);
	void AngleVectorsNothing2(const Vector vecForward, QAngle& vecAngles);
