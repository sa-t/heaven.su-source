...
void ImGuiRendering::DrawRing(int16_t x, int16_t y, int16_t z, int16_t radius, uint16_t points, Color color1, Color color2, float thickness, float prog, bool fill_prog)
{
	ImGuiWindow* window = ImGui::GetCurrentWindow();
	static float Step = (M_PI * 2.0f) / (points);
	std::vector<ImVec2> point;
