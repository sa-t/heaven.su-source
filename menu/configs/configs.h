...
struct Config
{
	...
	struct Ragebot_t
	{
		...
		bool extrapolation_can_be_used = false;
		bool smart_extrapolation;
		bool force_extrapolation;
		int extrapolation_type;
		bool extrapolation_used = false;
		int extrapolation_type_used = false;

		int desync_roll_range_left;
		int desync_roll_range_right;
	...
	struct Visuals_t
	{
		...
		Color grenade_prediction_color_can_hit;
		bool hitsound;
