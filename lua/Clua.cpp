...
void  get_interface(const char* mod_name, const char* interface_name, bool exact = false) {
	T* iface = nullptr;
...
namespace ns_client
{
	...
	{
		if (eventname != crypt_str("on_paint") && eventname != crypt_str("on_createmove") && eventname != crypt_str("on_shot") && eventname != crypt_str("on_framestage"))
		{
...
void* EasyInterface(HMODULE pImageName, const std::string& pName) {
	CreateInterfaceFn pFn = (CreateInterfaceFn)(GetProcAddress(pImageName, "CreateInterface"));
	if (!pFn)
		return nullptr;

	void* pFactory = pFn(pName.c_str(), nullptr);

	return pFactory;
}

static void* create_interface(const char* pModule, const char* pInterfaceName)
{
	return EasyInterface(GetModuleHandleA(pModule), pInterfaceName);
}
...
namespace ns_console
{
	...
	void create_interface(const char* mod_name, const char* interface_name, bool exact = false)
	{
...
void c_lua::initialize()
{
	...
	client[crypt_str("get_framerate")] = ns_globals::get_framerate;
	client[crypt_str("get_ping")] = ns_globals::get_ping;
	client[crypt_str("get_server_address")] = ns_globals::get_server_address;
	client[crypt_str("get_time")] = ns_globals::get_time;
	client[crypt_str("get_username")] = ns_globals::get_username;
	client[crypt_str("get_realtime")] = ns_globals::get_realtime;
	client[crypt_str("get_curtime")] = ns_globals::get_curtime;
	client[crypt_str("get_frametime")] = ns_globals::get_frametime;
	client[crypt_str("get_tickcount")] = ns_globals::get_tickcount;
	client[crypt_str("get_framecount")] = ns_globals::get_framecount;
	client[crypt_str("get_intervalpertick")] = ns_globals::get_intervalpertick;
	client[crypt_str("get_maxclients")] = ns_globals::get_maxclients;

	auto gui = lua.create_table();
	gui[crypt_str("next_line")] = ns_menu::next_line;
	gui[crypt_str("add_check_box")] = ns_menu::add_check_box;
	gui[crypt_str("add_combo_box")] = ns_menu::add_combo_box;
	gui[crypt_str("add_slider_int")] = ns_menu::add_slider_int;
	gui[crypt_str("add_slider_float")] = ns_menu::add_slider_float;
	gui[crypt_str("add_color_picker")] = ns_menu::add_color_picker;
	gui[crypt_str("get_bool")] = ns_menu::get_bool;
	gui[crypt_str("get_int")] = ns_menu::get_int;
	gui[crypt_str("get_float")] = ns_menu::get_float;
	gui[crypt_str("get_color")] = ns_menu::get_color;
	gui[crypt_str("get_key_bind_state")] = ns_menu::get_key_bind_state;
	gui[crypt_str("get_key_bind_mode")] = ns_menu::get_key_bind_mode;
	gui[crypt_str("set_bool")] = ns_menu::set_bool;
	gui[crypt_str("set_int")] = ns_menu::set_int;
	gui[crypt_str("set_float")] = ns_menu::set_float;
	gui[crypt_str("set_color")] = ns_menu::set_color;
	...
	renderer[crypt_str("get_text_width")] = ns_render::get_text_width;
	renderer[crypt_str("setup_font")] = ns_render::create_font;
	...
	renderer[crypt_str("rect")] = ns_render::draw_rect;
	renderer[crypt_str("rect_filled")] = ns_render::draw_rect_filled;
	renderer[crypt_str("rect_filled_gradient")] = ns_render::draw_rect_filled_gradient;
	...
	auto comand = lua.create_table();
	comand[crypt_str("execute")] = ns_console::execute;
	comand[crypt_str("get_int")] = ns_console::get_int;
	comand[crypt_str("get_float")] = ns_console::get_float;
	comand[crypt_str("get_string")] = ns_console::get_string;
	comand[crypt_str("set_int")] = ns_console::set_int;
	comand[crypt_str("set_float")] = ns_console::set_float;
	comand[crypt_str("set_string")] = ns_console::set_string;
	comand["create_interface"] = create_interface;
	...
	comand[crypt_str("get_send_packet")] = ns_cmd::get_send_packet;
	comand[crypt_str("set_send_packet")] = ns_cmd::set_send_packet;
	comand[crypt_str("get_choke")] = ns_cmd::get_choke;
	comand[crypt_str("get_button_state")] = ns_cmd::get_button_state;
	comand[crypt_str("set_button_state")] = ns_cmd::set_button_state;

	auto utils = lua.create_table();//new
	utils[crypt_str("find_signature")] = ns_utils::find_signature;//new


	auto network = lua.create_table();//new
	network[crypt_str("get")] = ns_http::get;//new
	network[crypt_str("post")] = ns_http::post;//new

	auto database = lua.create_table();//new
	database[crypt_str("append")] = ns_file::append; //new
	database[crypt_str("write")] = ns_file::write;//new
	database[crypt_str("read")] = ns_file::read;//new

	lua[crypt_str("client")] = client;
	lua[crypt_str("gui")] = gui;
	//lua[crypt_str("globals")] = globals;
	lua[crypt_str("engine")] = engine;
	lua[crypt_str("renderer")] = renderer;
	lua[crypt_str("comand")] = comand;
	lua[crypt_str("events")] = events;
	lua[crypt_str("entitylist")] = entitylist;
	lua[crypt_str("cmd")] = cmd;
	lua[crypt_str("utils")] = utils;//new
	lua[crypt_str("network")] = network;//new
	lua[crypt_str("database")] = database;//new
